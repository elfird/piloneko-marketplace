    ...
    <header className="sticky top-0 z-50 bg-[#0A0A0F]/85 backdrop-blur-md border-b border-accent-primary/20 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        ...
        <div 
          ...
          className="flex items-center gap-2 cursor-pointer font-orbitron font-black text-xl text-accent-primary tracking-widest text-neon relative group"
        >
          <span className="text-white group-hover:text-accent-secondary transition-colors duration-300">
            [
          </span>
